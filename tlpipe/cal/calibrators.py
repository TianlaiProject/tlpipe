...
src_data = {
    ...
    'j0133': ('J0133-3629',   '01:33:57.751',   '-36:29:35.80',   1.0440, -0.6619, -0.2252,  0.0,     0.0,     0.0,    np.radians(14.0 / 60)),
    '3c48' : ('3C48',         '01:37:41.3',   '+33:09:35.134',   1.3253, -0.7553, -0.1914,  0.0498,  0.0,     0.0,    np.radians(1.2 / 3600)),
    'for'  : ('Fornax A',     '03:22:41.7',  '-37:12:29.6',   2.2175, -0.6606,  0.0,     0.0,     0.0,     0.0,    np.radians(55.0 / 60)),
    '3c123': ('3C123',        '04:37:04.3752',   '+29:40:13.818',   1.8017, -0.7884, -0.1035, -0.0248,  0.0090,  0.0,    np.radians(44.0 / 3600)),
    'j0444': ('J0444-2809',   '04:44:32.0',   '-28:09:31.0',   0.9710, -0.8938, -0.1176,  0.0,     0.0,     0.0,    np.radians(2.0 / 60)),
    '3c138': ('3C138',        '05:21:09.8860',   '+16:38:22.051',   1.0088, -0.4981, -0.1552, -0.0102,  0.0223,  0.0,    np.radians(0.7 / 3600)),
    'pic'  : ('Pictor A',     '05:19:49.7',  '-45:46:43.780',   1.9380, -0.7470, -0.0739,  0.0,     0.0,     0.0,    np.radians(8.3 / 60)),
    'crab' : ('Taurus A',     '05:34:31.97',  '+22:00:52',   2.9516, -0.2173, -0.0473, -0.0674,  0.0,     0.0,    np.radians(0.0)),
    '3c147': ('3C147',        '05:42:36.1379',   '+49:51:07.234',   1.4516, -0.6961, -0.2007,  0.0640, -0.0464,  0.0289, np.radians(0.9 / 3600)),
    '3c196': ('3C196',        '08:13:36.0331',   '+48:13:02.560',   1.2872, -0.8530, -0.1534, -0.0200,  0.0201,  0.0,    np.radians(7.0 / 3600)),
    ...
    '3c286': ('3C286',        '13:31:08.2879',   '+30:30:32.958',   1.2481, -0.4507, -0.1798,  0.0357,  0.0,     0.0,    np.radians(3.0 / 3600)),
    '3c295': ('3C295',        '14:11:20.5188',   '+52:12:09.972',   1.4701, -0.7658, -0.2780, -0.0347,  0.0399,  0.0,    np.radians(5.0 / 3600)),
    'her'  : ('Hercules A',   '16:51:08.15', '+04:59:33.3',   1.8298, -0.1247, -0.0951,  0.0,     0.0,     0.0,    np.radians(3.1 / 60)),
    '3c353': ('3C353',        '17:20:28.1582',   '-00:58:46.621',   1.8627, -0.6938, -0.0998, -0.0732,  0.0,     0.0,    np.radians(5.3)),
    '3c380': ('3C380',        '18:29:31.7809',   '+48:44:46.160',   1.2320, -0.7909,  0.0947,  0.0976, -0.1794, -0.1566, np.radians(0.0)),
    'cyg'  : ('Cygnus A',     '19:59:28.3',  '+40:44:02',   3.3498, -1.0022, -0.2246,  0.0227,  0.0425,  0.0,    np.radians(2.0 / 60)),
    '3c444': ('3C444',        '22:14:25.7400',   '-17:01:35.800',   1.1064, -1.0052, -0.0750, -0.0767,  0.0,     0.0,    np.radians(2.0 / 60)),
