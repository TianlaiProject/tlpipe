/* Generated by Cython 0.19.1 on Sat Jan 23 18:29:43 2016 */
...
#endif
#include <math.h>
#define __PYX_HAVE__conv_ker
#define __PYX_HAVE_API__conv_ker
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_8conv_ker_FLOAT64_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'conv_ker' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_8conv_ker_FLOAT64_t = { "FLOAT64_t", NULL, sizeof(__pyx_t_8conv_ker_FLOAT64_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo___pyx_t_double_complex = { "double complex", NULL, sizeof(__pyx_t_double_complex), { 0 }, 0, 'C', 0, 0 };
#define __Pyx_MODULE_NAME "conv_ker"
int __pyx_module_is_main_conv_ker = 0;

/* Implementation of 'conv_ker' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_8conv_ker_conv_kernal(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_u, PyArrayObject *__pyx_v_v, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_ui, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_vi, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_sigma, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_l0, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_m0); /* proto */
...
static char __pyx_k_15[] = "/home/zuoshifan/programming/python/21cmcosmology/tlpipe/tlpipe/timestream/conv_ker.pyx";
...
static char __pyx_k__cfactor[] = "cfactor";
static char __pyx_k__float64[] = "float64";
static char __pyx_k__rfactor[] = "rfactor";
static char __pyx_k____main__[] = "__main__";
static char __pyx_k____test__[] = "__test__";
static char __pyx_k__conv_ker[] = "conv_ker";
static char __pyx_k__l0_factor[] = "l0_factor";
static char __pyx_k__m0_factor[] = "m0_factor";
static char __pyx_k__two_sigma[] = "two_sigma";
static char __pyx_k__COMPLEX128[] = "COMPLEX128";
static char __pyx_k__ValueError[] = "ValueError";
static char __pyx_k____import__[] = "__import__";
static char __pyx_k__complex128[] = "complex128";
static char __pyx_k__conv_kernal[] = "conv_kernal";
static char __pyx_k__RuntimeError[] = "RuntimeError";
static char __pyx_k__two_pi_sigma[] = "two_pi_sigma";
...
static PyObject *__pyx_n_s__cfactor;
static PyObject *__pyx_n_s__complex128;
static PyObject *__pyx_n_s__conv_ker;
static PyObject *__pyx_n_s__conv_kernal;
static PyObject *__pyx_n_s__dtype;
static PyObject *__pyx_n_s__exp;
static PyObject *__pyx_n_s__float64;
static PyObject *__pyx_n_s__ker;
static PyObject *__pyx_n_s__l0;
static PyObject *__pyx_n_s__l0_factor;
static PyObject *__pyx_n_s__m0;
static PyObject *__pyx_n_s__m0_factor;
...
static PyObject *__pyx_n_s__rfactor;
static PyObject *__pyx_n_s__sigma;
static PyObject *__pyx_n_s__two_pi_sigma;
static PyObject *__pyx_n_s__two_sigma;
...
/* Python wrapper */
static PyObject *__pyx_pw_8conv_ker_1conv_kernal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8conv_ker_1conv_kernal = {__Pyx_NAMESTR("conv_kernal"), (PyCFunction)__pyx_pw_8conv_ker_1conv_kernal, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_8conv_ker_1conv_kernal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_u = 0;
  PyArrayObject *__pyx_v_v = 0;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_ui;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_vi;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_sigma;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_l0;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_m0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("conv_kernal (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__u,&__pyx_n_s__v,&__pyx_n_s__ui,&__pyx_n_s__vi,&__pyx_n_s__sigma,&__pyx_n_s__l0,&__pyx_n_s__m0,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__v)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__ui)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__vi)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__sigma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__l0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__m0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "conv_kernal") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_ui = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_ui == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_vi = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_vi == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_sigma = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_sigma == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_l0 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_l0 == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_m0 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_m0 == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("conv_kernal", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("conv_ker.conv_kernal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_u), __pyx_ptype_5numpy_ndarray, 1, "u", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_v), __pyx_ptype_5numpy_ndarray, 1, "v", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_8conv_ker_conv_kernal(__pyx_self, __pyx_v_u, __pyx_v_v, __pyx_v_ui, __pyx_v_vi, __pyx_v_sigma, __pyx_v_l0, __pyx_v_m0);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_8conv_ker_conv_kernal(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_u, PyArrayObject *__pyx_v_v, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_ui, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_vi, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_sigma, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_l0, __pyx_t_8conv_ker_FLOAT64_t __pyx_v_m0) {
  unsigned int __pyx_v_nrow;
  unsigned int __pyx_v_ncol;
  PyArrayObject *__pyx_v_rfactor = 0;
  PyArrayObject *__pyx_v_cfactor = 0;
  PyArrayObject *__pyx_v_ker = 0;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_two_sigma;
  __pyx_t_8conv_ker_FLOAT64_t __pyx_v_two_pi_sigma;
  __pyx_t_double_complex __pyx_v_l0_factor;
  __pyx_t_double_complex __pyx_v_m0_factor;
  unsigned int __pyx_v_r;
  unsigned int __pyx_v_c;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_cfactor;
  __Pyx_Buffer __pyx_pybuffer_cfactor;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_ker;
  __Pyx_Buffer __pyx_pybuffer_ker;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_rfactor;
  __Pyx_Buffer __pyx_pybuffer_rfactor;
  ...
  __pyx_t_8conv_ker_FLOAT64_t __pyx_t_8;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("conv_kernal", 0);
  __pyx_pybuffer_rfactor.pybuffer.buf = NULL;
  __pyx_pybuffer_rfactor.refcount = 0;
  __pyx_pybuffernd_rfactor.data = NULL;
  __pyx_pybuffernd_rfactor.rcbuffer = &__pyx_pybuffer_rfactor;
  __pyx_pybuffer_cfactor.pybuffer.buf = NULL;
  __pyx_pybuffer_cfactor.refcount = 0;
  __pyx_pybuffernd_cfactor.data = NULL;
  __pyx_pybuffernd_cfactor.rcbuffer = &__pyx_pybuffer_cfactor;
  ...
  __pyx_pybuffernd_v.rcbuffer = &__pyx_pybuffer_v;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_u.rcbuffer->pybuffer, (PyObject*)__pyx_v_u, &__Pyx_TypeInfo_nn___pyx_t_8conv_ker_FLOAT64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_v.rcbuffer->pybuffer, (PyObject*)__pyx_v_v, &__Pyx_TypeInfo_nn___pyx_t_8conv_ker_FLOAT64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_v_nrow = (__pyx_v_v->dimensions[0]);
 ...
 */
  __pyx_v_ncol = (__pyx_v_u->dimensions[0]);
 ...
 */
  ...
  __pyx_t_1 = PyLong_FromUnsignedLong(__pyx_v_nrow); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s__COMPLEX128); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_4 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rfactor.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo___pyx_t_double_complex, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_rfactor = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_rfactor.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_rfactor.diminfo[0].strides = __pyx_pybuffernd_rfactor.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_rfactor.diminfo[0].shape = __pyx_pybuffernd_rfactor.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_5 = 0;
  __pyx_v_rfactor = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s__zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyLong_FromUnsignedLong(__pyx_v_ncol); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s__COMPLEX128); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_4, ((PyObject *)__pyx_n_s__dtype), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_cfactor.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo___pyx_t_double_complex, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_cfactor = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_cfactor.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_cfactor.diminfo[0].strides = __pyx_pybuffernd_cfactor.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_cfactor.diminfo[0].shape = __pyx_pybuffernd_cfactor.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_cfactor = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyLong_FromUnsignedLong(__pyx_v_nrow); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyLong_FromUnsignedLong(__pyx_v_ncol); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s__COMPLEX128); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_4, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ker.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo___pyx_t_double_complex, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_7 = 0;
  __pyx_v_ker = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;
 ...
 */
  __pyx_v_two_sigma = (2.0 * __pyx_v_sigma);
 ...
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_two_sigma); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s__pi); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_two_pi_sigma = __pyx_t_8;
 ...
 * 
 */
  __pyx_t_9 = __pyx_t_double_complex_from_parts(0, 0.5);
  __pyx_t_10 = __Pyx_c_prod_npy_float64(__pyx_t_npy_float64_complex_from_parts(__Pyx_CREAL(__pyx_t_9), __Pyx_CIMAG(__pyx_t_9)), __pyx_t_npy_float64_complex_from_parts(__pyx_v_l0, 0));
  __pyx_t_11 = __pyx_t_npy_float64_complex_from_parts(__pyx_v_two_sigma, 0);
  ...
  __pyx_t_12 = __Pyx_c_quot_npy_float64(__pyx_t_10, __pyx_t_11);
  __pyx_v_l0_factor = __pyx_t_double_complex_from_parts(__Pyx_CREAL(__pyx_t_12), __Pyx_CIMAG(__pyx_t_12));
 ...
 */
  __pyx_t_9 = __pyx_t_double_complex_from_parts(0, 0.5);
  __pyx_t_12 = __Pyx_c_prod_npy_float64(__pyx_t_npy_float64_complex_from_parts(__Pyx_CREAL(__pyx_t_9), __Pyx_CIMAG(__pyx_t_9)), __pyx_t_npy_float64_complex_from_parts(__pyx_v_m0, 0));
  __pyx_t_11 = __pyx_t_npy_float64_complex_from_parts(__pyx_v_two_sigma, 0);
  if (unlikely(__Pyx_c_is_zero_npy_float64(__pyx_t_11))) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
  ...
  __pyx_t_10 = __Pyx_c_quot_npy_float64(__pyx_t_12, __pyx_t_11);
  __pyx_v_m0_factor = __pyx_t_double_complex_from_parts(__Pyx_CREAL(__pyx_t_10), __Pyx_CIMAG(__pyx_t_10));
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s__exp); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_15 = __pyx_v_r;
    __pyx_t_9 = __Pyx_c_neg(__Pyx_c_pow(__Pyx_c_diff(__pyx_t_double_complex_from_parts((__pyx_v_two_pi_sigma * ((*__Pyx_BufPtrStrided1d(__pyx_t_8conv_ker_FLOAT64_t *, __pyx_pybuffernd_v.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_v.diminfo[0].strides)) - __pyx_v_vi)), 0), __pyx_v_m0_factor), __pyx_t_double_complex_from_parts(2, 0)));
    __pyx_t_1 = __pyx_PyComplex_FromComplex(__pyx_t_9); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(((PyObject *)__pyx_t_1));
    ...
    __pyx_t_9 = __Pyx_PyComplex_As___pyx_t_double_complex(__pyx_t_1); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_16 = __pyx_v_r;
    *__Pyx_BufPtrStrided1d(__pyx_t_double_complex *, __pyx_pybuffernd_rfactor.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_rfactor.diminfo[0].strides) = __pyx_t_9;
  }
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s__exp); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_17 = __pyx_v_c;
    __pyx_t_9 = __Pyx_c_neg(__Pyx_c_pow(__Pyx_c_diff(__pyx_t_double_complex_from_parts((__pyx_v_two_pi_sigma * ((*__Pyx_BufPtrStrided1d(__pyx_t_8conv_ker_FLOAT64_t *, __pyx_pybuffernd_u.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_u.diminfo[0].strides)) - __pyx_v_ui)), 0), __pyx_v_l0_factor), __pyx_t_double_complex_from_parts(2, 0)));
    __pyx_t_1 = __pyx_PyComplex_FromComplex(__pyx_t_9); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(((PyObject *)__pyx_t_1));
    ...
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
    __pyx_t_9 = __Pyx_PyComplex_As___pyx_t_double_complex(__pyx_t_1); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_18 = __pyx_v_c;
    *__Pyx_BufPtrStrided1d(__pyx_t_double_complex *, __pyx_pybuffernd_cfactor.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_cfactor.diminfo[0].strides) = __pyx_t_9;
  }
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_double_complex *, __pyx_pybuffernd_ker.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_ker.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_ker.diminfo[1].strides) = __Pyx_c_prod((*__Pyx_BufPtrStrided1d(__pyx_t_double_complex *, __pyx_pybuffernd_rfactor.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_rfactor.diminfo[0].strides)), (*__Pyx_BufPtrStrided1d(__pyx_t_double_complex *, __pyx_pybuffernd_cfactor.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_cfactor.diminfo[0].strides)));
    }
  }
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_cfactor.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_ker.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_rfactor.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_v.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_rfactor);
  __Pyx_XDECREF((PyObject *)__pyx_v_cfactor);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__cfactor, __pyx_k__cfactor, sizeof(__pyx_k__cfactor), 0, 0, 1, 1},
  {&__pyx_n_s__complex128, __pyx_k__complex128, sizeof(__pyx_k__complex128), 0, 0, 1, 1},
  {&__pyx_n_s__conv_ker, __pyx_k__conv_ker, sizeof(__pyx_k__conv_ker), 0, 0, 1, 1},
  {&__pyx_n_s__conv_kernal, __pyx_k__conv_kernal, sizeof(__pyx_k__conv_kernal), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__l0_factor, __pyx_k__l0_factor, sizeof(__pyx_k__l0_factor), 0, 0, 1, 1},
  {&__pyx_n_s__m0, __pyx_k__m0, sizeof(__pyx_k__m0), 0, 0, 1, 1},
  {&__pyx_n_s__m0_factor, __pyx_k__m0_factor, sizeof(__pyx_k__m0_factor), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__rfactor, __pyx_k__rfactor, sizeof(__pyx_k__rfactor), 0, 0, 1, 1},
  {&__pyx_n_s__sigma, __pyx_k__sigma, sizeof(__pyx_k__sigma), 0, 0, 1, 1},
  {&__pyx_n_s__two_pi_sigma, __pyx_k__two_pi_sigma, sizeof(__pyx_k__two_pi_sigma), 0, 0, 1, 1},
  {&__pyx_n_s__two_sigma, __pyx_k__two_sigma, sizeof(__pyx_k__two_sigma), 0, 0, 1, 1},
 ...
 *     cdef unsigned int ncol = u.shape[0]
 */
  __pyx_k_tuple_13 = PyTuple_Pack(18, ((PyObject *)__pyx_n_s__u), ((PyObject *)__pyx_n_s__v), ((PyObject *)__pyx_n_s__ui), ((PyObject *)__pyx_n_s__vi), ((PyObject *)__pyx_n_s__sigma), ((PyObject *)__pyx_n_s__l0), ((PyObject *)__pyx_n_s__m0), ((PyObject *)__pyx_n_s__nrow), ((PyObject *)__pyx_n_s__ncol), ((PyObject *)__pyx_n_s__rfactor), ((PyObject *)__pyx_n_s__cfactor), ((PyObject *)__pyx_n_s__ker), ((PyObject *)__pyx_n_s__two_sigma), ((PyObject *)__pyx_n_s__two_pi_sigma), ((PyObject *)__pyx_n_s__l0_factor), ((PyObject *)__pyx_n_s__m0_factor), ((PyObject *)__pyx_n_s__r), ((PyObject *)__pyx_n_s__c)); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_13));
  __pyx_k_codeobj_14 = (PyObject*)__Pyx_PyCode_New(7, 0, 18, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__conv_kernal, 15, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initconv_ker(void); /*proto*/
PyMODINIT_FUNC initconv_ker(void)
#else
PyMODINIT_FUNC PyInit_conv_ker(void); /*proto*/
PyMODINIT_FUNC PyInit_conv_ker(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_conv_ker(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("conv_ker"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "conv_ker")) {
      if (unlikely(PyDict_SetItemString(modules, "conv_ker", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_conv_ker) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__FLOAT64, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__complex128); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__COMPLEX128, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef unsigned int ncol = u.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8conv_ker_1conv_kernal, NULL, __pyx_n_s__conv_ker); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__conv_kernal, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init conv_ker", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init conv_ker");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
