...
from tlpipe.map.fmmode.telescope import cylbeam
...
class CylinderTelescope(telescope.TransitTelescope):
    ...
    def __init__(self, latitude=45, longitude=0, freqs=[], beam_theta_range=[0.0, 180.0], tsys_flat=50.0, ndays=1.0, accuracy_boost=1.0, l_boost=1.0, bl_range=[0.0, 1.0e7], auto_correlations=False, num_cylinders=3, num_feeds=96, cylinder_width=15.0, feed_spacing=0.4, in_cylinder=True, touching=True, cylspacing=0.0, non_commensurate=False, e_width=0.7, h_width=1.0):

        telescope.TransitTelescope.__init__(self, latitude, longitude, freqs, beam_theta_range, tsys_flat, ndays, accuracy_boost, l_boost, bl_range, auto_correlations)
        ...
        self.cylspacing = cylspacing
        self.non_commensurate = non_commensurate
